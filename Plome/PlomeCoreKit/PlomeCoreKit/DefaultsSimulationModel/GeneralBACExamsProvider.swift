...
struct GeneralBACExamsProvider {
    ...
    private static var premiereContinuousControls: [Exam] = [
        ...
        .init(name: L10n._1ScientificEducation, coefficient: 3, grade: nil, ratio: 20, type: .continuousControl),
    ...
    private static var terminaleTrials: [Exam] = [
        .init(name: L10n.grandOral, coefficient: 10, grade: nil, ratio: 20, type: .trial),
        .init(name: L10n.philosophy, coefficient: 8, grade: nil, ratio: 20, type: .trial),
    ...
    private static var terminaleContinuousControls: [Exam] = [
        .init(name: L10n.tScientificEducation, coefficient: 3, grade: nil, ratio: 20, type: .continuousControl),
