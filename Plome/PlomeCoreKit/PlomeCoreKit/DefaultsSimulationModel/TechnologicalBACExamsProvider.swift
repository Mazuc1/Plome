...
struct TechnologicalBACExamsProvider {
    ...
    private static var premiereContinuousControls: [Exam] = [
        ...
        .init(name: L10n.math, coefficient: 3, grade: nil, ratio: nil, type: .continuousControl),
    ...
    private static var terminaleTrials: [Exam] = [
        .init(name: L10n.grandOral, coefficient: 14, grade: nil, ratio: nil, type: .trial),
        .init(name: L10n.philosophy, coefficient: 4, grade: nil, ratio: nil, type: .trial),
    ...
    private static var terminaleContinuousControls: [Exam] = [
        .init(name: L10n.tMath, coefficient: 3, grade: nil, ratio: nil, type: .continuousControl),
